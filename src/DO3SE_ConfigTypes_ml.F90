...
!   #include "DO3SE_Util_ml.h"
    ...
    TYPE, public :: Season_t
      ...
      INTEGER :: mid_anthesis = IUNDEF
      INTEGER :: sowing_day = IUNDEF
  ...
  !       ! Nothing to do
  !     case ("Ewert")
  !       ASSERT_DEFINED(pn_gsto%t_l)
  !       ASSERT_DEFINED(pn_gsto%t_lem)
  !       ASSERT_DEFINED(pn_gsto%t_lma)
  !       ASSERT_DEFINED(pn_gsto%t_lep)
  !       ASSERT_DEFINED(pn_gsto%t_lse)
  !     case default
